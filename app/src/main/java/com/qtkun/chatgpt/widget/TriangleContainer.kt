package com.qtkun.chatgpt.widget
...
import com.qtkun.chatgpt.ext.asDp
...
fun TriangleContainer.showTop(popupWindow: PopupWindow, anchor: View) {
    ...
    val offset = ScreenUtils.getScreenWidth() - location[0] + abs(dx) - popupWindow.contentView.measuredWidth
    if (offset < 0) {
